...
## Задание 3
<details><summary><b> Текст Задания.Logstash и Nginx </b> (нажмите, чтобы раскрыть)</summary>
<br>
...
## Решение
![Скриншот вывода команды](Scrins/logstash.png)

## Задание 4
<details><summary><b> Текст Задания.Filebeat </b> (нажмите, чтобы раскрыть)</summary>
<br>
...
## Решение
![Скриншот вывода команды](Scrins/filebeat.png)
