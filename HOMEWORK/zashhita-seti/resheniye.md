...
<br>
 ...
 ![Скриншот вывода команды](scrins/f2of.png)
</details>


<details><summary><b> Скрин логов и Блокировки Fail2Ban  </b> (нажмите, чтобы раскрыть)</summary>
<br>
...
* **Обе системы успешно обнаружили и предотвратили брутфорс-атаку на SSH. Suricata зафиксировала аномалию на сетевом уровне, а Fail2Ban реализовал активную защиту, временно заблокировав IP-адрес атакующего. 
     Комплексное использование обеих систем обеспечивает многоуровневую защиту**
